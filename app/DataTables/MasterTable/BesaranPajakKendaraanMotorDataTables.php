...
use App\Models\BesaranPajakKendaraanMotor;
use Yajra\DataTables\Services\DataTable;
use Yajra\DataTables\EloquentDataTable;

class BesaranPajakKendaraanMotorDataTables extends DataTable
{
    ...
    public function query(BesaranPajakKendaraanMotor $model)
    {
