...
use App\Models\BesaranPajakKendaraanMobil;
use Yajra\DataTables\Services\DataTable;
use Yajra\DataTables\EloquentDataTable;

class BesaranPajakKendaraanMobilDataTables extends DataTable
{
    ...
    public function query(BesaranPajakKendaraanMobil $model)
    {
