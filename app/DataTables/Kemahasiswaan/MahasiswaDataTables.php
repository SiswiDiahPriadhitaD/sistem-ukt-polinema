...
class MahasiswaDataTables extends DataTable
{
    public function dataTable($query)
    {
        ...
        return $dataTable
            ...
            ->editColumn('jurusan.nama_jurusan', function ($row) {
    ...
    public function query(Mahasiswa $model)
    {
        return $model->newQuery()
            ...
            ->where('mahasiswa.status_verifikasi', '=', 'Proses Diverifikasi');
    }
    ...
    public function html()
    {
        return $this->builder()
            ->columns([
                ...
                ['data' => 'jurusan.nama_jurusan', 'name' => 'jurusan.nama_jurusan', 'title' => 'Jurusan'],
                ['data' => 'program_studi', 'name' => 'program_studi', 'title' => 'Program Studi', 'orderable' => false, 'searchable' => false],
