...
class PeriodeMahasiswaDiverifikasiDataTables extends DataTable
{
    public function dataTable($query)
    {
        ...
        return $dataTable
            ...
            ->addColumn('action', function ($row) {
                $viewDiverifikasiBtn = '<a href="' . route('mahasiswa.diverifikasi.table', $row->id) . '" class="btn btn-warning btn-sm mr-1">Lihat Data Diverifikasi</a>';
                return '<div class="text-center">' . $viewDiverifikasiBtn  . '</div>';
            })
