...
class PeriodeMahasiswaPerhitunganDataTables extends DataTable
{
    public function dataTable($query)
    {
        ...
        return $dataTable
            ...
            ->addColumn('action', function ($row) {
                $viewDitolakBtn = '<a href="' . route('mahasiswa.perhitungan.table', $row->id) . '" class="btn btn-warning btn-sm mr-1">Lihat Data Perhitungan</a>';
