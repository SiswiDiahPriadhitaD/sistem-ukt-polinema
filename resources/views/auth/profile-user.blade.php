...
@section('content')
    <section class="section" style="padding-left: 100px;padding-right: 100px;">
        <div class="section-body">
            ...
            <div class="row mt-4">
                ...
                <div class="col-12 col-md-7">
                    ...
                    <!-- Additional Form for Personal Data -->
                    <div class="card shadow-sm">
                        <form method="POST" action="{{ route('profile.user.update', auth()->user()->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="card-header bg-gradient-primary text-white text-center font-weight-bold"
                                style="font-size: 1.5em;">
                            ...
                            <div class="card-footer text-right">
                                <button class="btn btn-primary" type="submit">Ubah Data Diri</button>
                            </div>
                        </form>
                    </div>
                </div>
